...
import { useUpdateTierLimits } from "@/hooks/useTierConfig";
...
export function TierLimitsDialog({
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      await updateTierLimits.mutateAsync({
        tier,
        limits: values,
      });
      onOpenChange(false);
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Free property listings allowed per month
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Free enquiry listings allowed per month
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Free property enquiry submissions allowed per month
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={updateTierLimits.isPending}>
                {updateTierLimits.isPending && (
